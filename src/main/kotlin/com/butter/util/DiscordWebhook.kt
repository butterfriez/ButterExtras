...
class DiscordWebhook(private val url: String) {
    ...
    fun execute() {
        if (content == null && embeds.isEmpty()) {
            throw IllegalArgumentException("Set content or add at least one com.butter.util.EmbedObject")
        }
        val json = JSONObject()
        ...
        connection.addRequestProperty("User-Agent", "Java-com.butter.util.DiscordWebhook-BY-Gelox_")
