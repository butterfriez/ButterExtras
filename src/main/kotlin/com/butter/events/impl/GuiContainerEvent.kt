 ...
 */
package com.butter.events.impl

import com.butter.events.ButterEvent
...
abstract class GuiContainerEvent {
    ...
    abstract class GuiContainerEvent(open val gui: GuiContainer, open val container: Container) : ButterEvent() {
